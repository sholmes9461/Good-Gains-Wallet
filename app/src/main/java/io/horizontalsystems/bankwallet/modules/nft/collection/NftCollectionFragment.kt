...
class NftCollectionFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                ...
                val blockchainTypeStringFromIntent = activity?.intent?.data?.getQueryParameter("blockchainType")
                if (uid != null) {
                    activity?.intent?.data = null
                }
                val nftCollectionUid = requireArguments().getString(collectionUidKey, uid ?: "")
                val blockchainTypeString = requireArguments().getString(blockchainTypeKey, blockchainTypeStringFromIntent ?: "")
    ...
    companion object {
        ...
        fun prepareParams(collectionUid: String, blockchainType: BlockchainType) =
            bundleOf(collectionUidKey to collectionUid, blockchainTypeKey to blockchainType.toString())
    }
}
            ...
            HorizontalPager(
                ...
                when (tabs[page]) {
                    ...
                    NftCollectionModule.Tab.Activity -> {
                        NftCollectionEventsScreen(navController, viewModel.blockchainType, viewModel.collectionUid)
                    }
                }
            }
        }
